...
//   cryptoCreateAccount: 'createAccount',
...
class Transaction {
  ...
  initBody(options) {
    ...
    return {
      ...
      transactionFee: options.transactionFee || DEFAULT_TX_FEE,
  ...
  getTransactionId() {
    return util.getTransactionId(this.tx);
  }
  ...
  static async handleResponse(response) {
    ...
    return TRANSACTION_RESPONSE_CODE[response.nodeTransactionPrecheckCode];
  }
