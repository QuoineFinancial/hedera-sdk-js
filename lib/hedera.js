...
class Hedera {
  constructor(nodeUrl, nodeAccountId, operatorId, operatorPublicKey, operatorPrivateKey) {
    ...
    if (!operatorPublicKey) throw Error('Missing operatorPublicKey');
    ...
    this.operatorPublicKey = util.fromPublicKeyDer(operatorPublicKey);
